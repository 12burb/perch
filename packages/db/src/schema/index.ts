 ...
 * sessions; task 1.15 adds brains; task 1.16 adds connections; task 1.17 adds mcp_servers; task 2.6 adds bots; task 2.10 adds inbox_items; later tasks add work and repo_index with their own migrations.
 */
