 ...
 * sessions; task 1.15 adds brains; task 1.16 adds connections; task 1.17 adds mcp_servers; task 2.6 adds bots; later tasks add work, inbox, and repo_index with their own migrations.
 */
