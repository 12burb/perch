 ...
 * sessions; task 1.15 adds brains; task 1.16 adds connections; task 1.17 adds mcp_servers; task 2.6 adds bots; task 2.10 adds inbox_items; task 2.17 adds repo_index; task 3.13 adds work_items, cycles and modules.
 */
